...
#' @export
#'
study_df_to_assessment_array <- function(training_set, m_fun, k_percentiles=c(5,50,95)) {
...
study_df_single_question_to_assessment_matrix <- function(test_set, m_fun, k_percentiles) {
  # Convert the test set to a matrix
  arr <- study_df_to_assessment_array(test_set, m_fun, k_percentiles)

...
results_df <- results_df |> filter(prediction_method %in% c("CohierarchicalCDF3QNoRCT(0.7)", "CoInCDF3QNoRNoCT"))
...
ggsave("output/relative_erros_boxplot.png", relative_erros_violins, width=10)

...
error_metrics = list(get_CDF_indep_class(), get_ratio_error_metric(), get_linear_error_metric())
...
for (error_metric in error_metrics) {
  for (summarizing_function in summarizing_functions) {
    if (error_metric$name == get_CDF_indep_class()$name && summarizing_function$name == get_median_summarizing_function()$name) {
      next
    }

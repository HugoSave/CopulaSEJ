...
test_m_matrix <- test_set |> study_df_single_question_to_assessment_matrix(summarizing_function$f, k_percentiles)
training_assessments <- training_set |> study_df_to_assessment_array(summarizing_function$f, k_percentiles)
